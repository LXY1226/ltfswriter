...
const (
	...
	ScsiOpFormatMedium         = 0x04
	ScsiOpReadBlockLimits      = 0x05
	ScsiOpRead                 = 0x08
	ScsiOpWrite                = 0x0A
	ScsiOpSetCapacity          = 0x0B
	ScsiOpWriteFilemarks       = 0x10
	ScsiOpSpace6               = 0x11
	ScsiOpInquiry              = 0x12
	ScsiOpVerify               = 0x13
	ScsiOpModeSelect6          = 0x15
	ScsiOpReserveUnit          = 0x16
	ScsiOpReleaseUnit          = 0x17
	ScsiOpErase                = 0x19
	ScsiOpModeSense6           = 0x1A
	ScsiOpLoadUnload           = 0x1B
	ScsiOpReceiveDiagnostic    = 0x1C
	ScsiOpSendDiagnostic       = 0x1D
	ScsiOpPreventAllowRemoval  = 0x1E
	ScsiOpReadCapacity         = 0x25
	ScsiOpRead10               = 0x28
	ScsiOpLocate10             = 0x2B
	ScsiOpReadPosition         = 0x34
	ScsiOpWriteBuffer          = 0x3B
	ScsiOpReadBuffer           = 0x3C
	ScsiOpReadToc              = 0x43
	ScsiOpReportDensity        = 0x44
	ScsiOpLogSelect            = 0x4C
	ScsiOpLogSense             = 0x4D
	ScsiOpModeSelect10         = 0x55
	ScsiOpReserveUnit10        = 0x56
	ScsiOpReleaseUnit10        = 0x57
	ScsiOpModeSense10          = 0x5A
	ScsiOpPersistentReserveIn  = 0x5E
	ScsiOpPersistentReserveOut = 0x5F
	ScsiOpReadAttribute        = 0x8C
	ScsiOpWriteAttribute       = 0x8D
	ScsiOpSpace16              = 0x91
	ScsiOpLocate16             = 0x92
	ScsiOpReportLuns           = 0xA0
	ScsiOpSecurityProtocolIn   = 0xA2
	ScsiOpReportDeviceID       = 0xA3

	ScsiOpReportTargetPortGrp = 0xA30A
	ScsiOpReportSupportedOp   = 0xA30C
	ScsiOpReportSupportedTMF  = 0xA30D
	ScsiOpReportTimestamp     = 0xA30F

	ScsiOpEnhancedFWUpgRptImg   = 0xA31F05
	ScsiOpReadLoggedInHostTbl   = 0xA31F06
	ScsiOpReportSnapshots       = 0xA31F07
	ScsiOpReadSnapshotLog       = 0xA31F08
	ScsiOpReadSTTFLog           = 0xA31F09
	ScsiOpReportSnapshotCmds    = 0xA31F0A
	ScsiOpReportSnapshotCfg     = 0xA31F0B
	ScsiOpReportEnhSnapshotCfg  = 0xA31F0D
	ScsiOpReportSTTFCfg         = 0xA31F0E
	ScsiOpReadFirmwareTraceLog  = 0xA31F10
	ScsiOpReportIPConfig        = 0xA31F12
	ScsiOpManagementArmSelfTest = 0xA31F14
	ScsiOpReportNetworkStats    = 0xA31F15
	ScsiOpReportSTTFAvailable   = 0xA31F18

	ScsiOpSetDeviceID              = 0xA406
	ScsiOpSetTimestamp             = 0xA40F
	ScsiOpEnhancedFWUpgDwnldFwSeg  = 0xA41F05
	ScsiOpEnhancedFWUpgReboot      = 0xA41F06
	ScsiOpForcedEject              = 0xA41F07
	ScsiOpSetSnapshotCmds          = 0xA41F0A
	ScsiOpSetSnapshotCfg           = 0xA41F0B
	ScsiOpForceSnapshot            = 0xA41F0C
	ScsiOpSetEnhSnapshotCfg        = 0xA41F0D
	ScsiOpSetSTTFCfg               = 0xA41F0E
	ScsiOpClearProtectedSTTFLog    = 0xA41F14
	ScsiOpCreateFWUpgTapeFromFlash = 0xA442

	ScsiOpReadMediaSerialNum = 0xAB01

	ScsiOpSecurityProtocolOut = 0xB5
)

const (
	ModePageReadWriteErrorRecovery = 0x01
	ModePageDisconnectReconnect    = 0x02
	ModePageControl                = 0x0A
	ModePageDataCompression        = 0x0F
	ModePageDeviceConfiguration    = 0x10
	ModePageMediumPartitions       = 0x11
	ModePageLunControl             = 0x18
	ModePagePortControl            = 0x19
	ModePagePowerCondition         = 0x1A
	ModePageInformationExceptions  = 0x1C
	ModePageMediumConfiguration    = 0x1D
	ModePageSerialNumberOverride   = 0x3B
	ModePageDeviceTime             = 0x3C
	ModePageExtendedReset          = 0x3D
	ModePageCDROMEmulation         = 0x3E
...
const (
	...
	LogPageSequentialAccessDevice = 0x0C
	LogPageTemperature            = 0x0D
	LogPageDTDStatus              = 0x11
	LogPageTapeAlertResponse      = 0x12
	LogPageRequestedRecovery      = 0x13
	LogPageDeviceStatistics       = 0x14
	LogPageServiceBuffersInfo     = 0x15
	LogPageTapeDiagnosticsData    = 0x16
	LogPageVolumeStatistics       = 0x17
	LogPageSASPort                = 0x18
	LogPageDataCompression        = 0x1B
	LogPageTapeAlert              = 0x2E
	LogPageTapeUsage              = 0x30
	LogPageTapeCapacity           = 0x31
	LogPageDataCompressionHP      = 0x32
	LogPageDeviceWellness         = 0x33
	LogPagePerformance            = 0x34
	LogPageDTDeviceError          = 0x35
	LogPageDeviceStatus           = 0x3E
)
